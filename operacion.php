...
class BaseDatos
  {
  	...
  	public function recuperar()
    {
      //echo $this->correo;
        ...
        $consulta_c="select * from registro_usuarios where correo='$this->correo'";
          //echo $consulta_c;
          ...
          if ($res) {
            ...
            $contraseña_encriptada=md5($contrasena);
              ...
              try {
                  ...
                  $mail->isHTML(true);
                  $mail->Subject = utf8_decode('Recuperación de contraseña  TuTienda virtual');
                  $mail->Body    = utf8_decode('Ingrese al siguiente link para cambiar la contraseña'.' http://localhost/ronald/versiones/proyecto0.2/nueva_contrase%C3%B1a_usu.html');
                  $mail->send();
                  ...
                  echo'<script type="text/javascript">
                        ...
                        window.location.href="index.html";
                          ...
                          echo'<script type="text/javascript">
                                ...
                                window.location.href="recuperar_cuenta.html";
                                </script>';
